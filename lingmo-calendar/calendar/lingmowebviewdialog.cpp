...
LingmoWebviewDialogStatus status;

LingmoWebviewDialog::LingmoWebviewDialog(QWidget *parent) :
    QDialog(parent, Qt::FramelessWindowHint | Qt::Tool | Qt::X11BypassWindowManagerHint),
    ui(new Ui::LingmoWebviewDialog)
{
    ui->setupUi(this);
...
LingmoWebviewDialog::~LingmoWebviewDialog()
{
    delete ui;
}

void LingmoWebviewDialog::creatwebview(int _mode, int _panelSize)
{
}
...
*/
bool LingmoWebviewDialog::eventFilter(QObject *obj, QEvent *event)
{
    if (obj == this)
    {
