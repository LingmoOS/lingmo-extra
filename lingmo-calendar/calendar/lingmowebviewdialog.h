...
namespace Ui {
class LingmoWebviewDialog;
}
enum LingmoWebviewDialogStatus{ST_HIDE,ST_SHOW};
...
class LingmoWebviewDialog : public QDialog
{
    Q_OBJECT

public:
    explicit LingmoWebviewDialog(QWidget *parent = nullptr);
    ~LingmoWebviewDialog();
