...
class LingmoLog4qtRolling : public QThread
{
public:
    LingmoLog4qtRolling(QString strBaseFilePath, unsigned uMaxFileCount = 0, quint64 uMaxFileSize = 0, 
        quint64 delayCheckFileTime = 0, QObject *parent = nullptr);
    virtual ~LingmoLog4qtRolling();
