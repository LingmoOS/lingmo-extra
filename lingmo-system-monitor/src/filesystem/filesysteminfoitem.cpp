...
void FileSystemInfoItem::initUI()
{
    ...
    m_progressBar = new KProgressBar(this, "filesystem");
    m_progressBar->setMaxValue(100);
    m_progressBar->setThresholdValue(80, 90);
    m_progressBar->setFixedHeight(6);
    m_progressBar->setMinimumWidth(623);
    m_progressBar->setColorAttr(QColor("#3790FA"),QColor("#CFD2CF"),QColor("#3790FA"),QColor("#3790FA"));
...
void FileSystemInfoItem::onUpdateInfo(FileSystemData& fsData)
{
    ...
    m_progressBar->setCurValue(fsData.usedPercentage());
...
void FileSystemInfoItem::onThemeStyleChange(QString strStyleName)
{
    if(strStyleName == "lingmo-dark" || strStyleName == "lingmo-black") {
        this->setStyleSheet("QPushButton{text-align:center;border: none;border-radius: 6px;outline: none;"
                            ...
                            "QPushButton::checked {background-color: rgba(55, 55, 55, 100%);}");
        if (m_progressBar) {
            m_progressBar->setColorAttr(QColor("#3790FA"),QColor("#4A5355"),QColor("#3790FA"),QColor("#3790FA"));
        }
    } else {
        this->setStyleSheet("QPushButton{text-align:center;border: none;border-radius: 6px;outline: none;"
                            ...
                            "QPushButton::checked {background-color: rgba(218, 218, 218, 100%);}");
        if (m_progressBar) {
            m_progressBar->setColorAttr(QColor("#3790FA"),QColor("#CFD2CF"),QColor("#3790FA"),QColor("#3790FA"));
        }
    }
