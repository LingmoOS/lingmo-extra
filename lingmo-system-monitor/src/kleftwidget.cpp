...
void KLeftWidget::initUI()
{
    ...
    m_labelTitle  = new QLabel(tr("Lingmo System Monitor"), this);
    ...
    m_scrollOptions->setStyleSheet("QScrollArea{background-color: transparent;}");
    m_scrollOptions->viewport()->setStyleSheet("background-color: transparent;");
    ...
    m_netHisWidget->setFixedSize(LEFT_BUTTON_WIDTH,200);
...
void KLeftWidget::setTabletMode(bool b)
{
   this->tabletMode = b;
   if (tabletMode) {
       m_buttonBar->setMinimumHeight(156);
   } else {
       m_buttonBar->setMinimumHeight(120);
   }
}
