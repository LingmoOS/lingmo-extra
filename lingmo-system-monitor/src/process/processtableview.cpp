...
void ProcessTableView::showEndProcessDialog()
{
    ...
    endProcessMsgBox.addButton(QString(tr("Cancel")), QMessageBox::NoRole);
    endProcessMsgBox.addButton(QString(tr("End process")), QMessageBox::ApplyRole);
...
void ProcessTableView::showKillProcessDialog()
{
    ...
    killProcessMsgBox.addButton(QString(tr("Cancel")), QMessageBox::NoRole);
    killProcessMsgBox.addButton(QString(tr("Kill process")), QMessageBox::ApplyRole);
