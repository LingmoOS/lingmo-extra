...
void MemHistoryWidget::initUI()
{
    ...
    m_progressBarMem = new KProgressBar();
    m_progressBarMem->setMaxValue(100);
    m_progressBarMem->setThresholdValue(80, 90);
    m_progressBarMem->setFixedSize(160, 4);
    m_progressBarMem->setColorAttr(QColor("#52C429"),QColor("#CFD2CF"),QColor("#52C429"),QColor("#52C429"));
    m_memProgLayout->addWidget(m_progressBarMem);

    m_progressBarSwap = new KProgressBar();
    m_progressBarSwap->setMaxValue(100);
    m_progressBarSwap->setThresholdValue(80, 90);
    m_progressBarSwap->setFixedSize(160, 4);
    m_progressBarSwap->setColorAttr(QColor("#F68C27"),QColor("#CFD2CF"),QColor("#F68C27"),QColor("#F68C27"));
...
void MemHistoryWidget::onThemeStyleChange(QString strStyleName)
{
    ...
    if(strStyleName == "lingmo-dark" || strStyleName == "lingmo-black") {
        ...
        if (m_progressBarMem) {
            m_progressBarMem->setColorAttr(QColor("#52C429"),QColor("#4A5355"),QColor("#52C429"),QColor("#52C429"));
        }
        if (m_progressBarSwap) {
            m_progressBarSwap->setColorAttr(QColor("#F68C27"),QColor("#4A5355"),QColor("#F68C27"),QColor("#F68C27"));
        }
...
void MemHistoryWidget::onUpdateMemData(qreal memUsed, qreal memTotal)
{
    ...
    m_progressBarMem->setCurValue(memPercent);
...
void MemHistoryWidget::onUpdateSwapData(qreal swapUsed, qreal swapTotal)
{
    ...
    m_progressBarSwap->setCurValue(swapPercent);
...
{
    return QString::number(m_progressBarMem->getCurValue(), 'f', 1) + "%";
}
