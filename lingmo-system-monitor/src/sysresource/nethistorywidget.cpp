...
void NetHistoryWidget::initUI()
{
    ...
    m_labelSendTitle->setAlignment(Qt::AlignLeft|Qt::AlignVCenter);
    ...
    m_labelSendValue->setAlignment(Qt::AlignRight|Qt::AlignVCenter);
    ...
    m_labelRecvTitle->setAlignment(Qt::AlignLeft|Qt::AlignVCenter);
    ...
    m_labelRecvValue->setAlignment(Qt::AlignRight|Qt::AlignVCenter);
