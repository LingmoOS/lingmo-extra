...
{
    QString network = tr("NET: ");
    QString cpuAndNet = tr("CPU: ") + m_cpuHisWidget->getCpuOccupancy() + "  " + network;
    QString memoryAndNetSend = tr("RAM: ") + m_memHisWidget->getMemOccupancy() + "  " + m_netHisWidget->getNetSendSpeed();
    ...
    QString diskAndNetLoad = tr("Disk: ") + diskOccupancy + "  " + m_netHisWidget->getNetLoadSpeed();
